...
public class Series {
    ...
    public void CrearListaSeries() {
        ...
        do {
            ...
            System.out.println("Ingrese la duración de la serie: ");
            duracion = sc.nextInt();
            series.setDuracion(duracion);

            System.out.println("Si desea agregar otra serie, digite S, de lo contrario digite cualquier letra para salir del programa ");
            fin = sc.next();
            añadirSerie(series);
